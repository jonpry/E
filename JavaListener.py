...
class JavaListener(ParseTreeListener):
    ...
    def enterEnumConstantName(self, ctx):
        pass

    # Exit a parse tree produced by JavaParser#enumConstantName.
    def exitEnumConstantName(self, ctx):
        pass
    ...
    def enterConstructorBody(self, ctx):
        pass

    # Exit a parse tree produced by JavaParser#constructorBody.
    def exitConstructorBody(self, ctx):
        pass
    ...
    def enterAnnotationName(self, ctx):
        pass

    # Exit a parse tree produced by JavaParser#annotationName.
    def exitAnnotationName(self, ctx):
        pass
    ...
    def exitLocalVariableDeclarationStatement(self, ctx):
        pass
    ...
    def exitStatementExpression(self, ctx):
        pass
